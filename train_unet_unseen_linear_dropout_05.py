...
for i in range(20):
    ...
    fn = './UNET_model/UKDALE_unseen_%d_linear_dropout_05.pth' %i
...
plt.yscale('log')
plt.grid(True)
plt.savefig('./UNET_model/unseen_loss_linear_dropout_05.png')
plt.show()
...
for i in range(20):
    ...
    filename = './UNET_model/UKDALE_unseen_%d_linear_dropout_05.pth' %i
    print(filename)
    model.load_state_dict(torch.load(filename))
    for a in range(3):
