...
store = pd.HDFStore('/public/home/jd_jzy/ukdale.h5')
...
def get_series(datastore, house, label, cutoff):
    filename = r'/public/home/jd_jzy/anaconda3_new/envs/nilmtk-env/lib/python3.6/site-packages/nilmtk/disaggregate/transferNILM-master/dataset_management/ukdale/uk2015/house_%1d/labels.dat' %house
    print(filename)
